...
from tsk.common.env import RELEASES_OP_USER, RELEASE_OP_BRANCH, NIGHTLY_OP_USER, NIGHTLY_OP_BRANCH
...
class RebootMenuUI:
  ...
  def __init__(self):
    ...
    self.release_button = Button(self.rebooter.release_action, [  # Call the method on the instance
      {"text": "Install", "x_offset": 70, "y_offset": 40},
      {"text": f"{RELEASES_OP_USER}/", "x_offset": 70, "y_offset": 140},
      {"text": f"{RELEASE_OP_BRANCH}", "x_offset": 70, "y_offset": 240},
    ], 600, button_height, button1_x, button_y, 90)

    self.nightly_button = Button(self.rebooter.nightly_action, [  # Call the method on the instance
      {"text": "Install", "x_offset": 70, "y_offset": 40},
      {"text": f"{NIGHTLY_OP_USER}/", "x_offset": 70, "y_offset": 140},
      {"text": f"{NIGHTLY_OP_BRANCH}", "x_offset": 70, "y_offset": 240},
