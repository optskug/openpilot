  ...
  def _wrap_text(self, text, font_size, max_width):
    ...
    for block in text.splitlines():
      ...
      for word in block.split():
        ...
        # Spacing = 5 since something broke in raylib and caused
        # measure_text_ex to under-report the width.
        if rl.measure_text_ex(font, test_line, font_size, 5).x <= max_width:
